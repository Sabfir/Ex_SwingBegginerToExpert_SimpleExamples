...
public class FormPanel extends JPanel {
    ...
    JButton okButton;
    JList<String> ageCategoriesList;
    ...
    public FormPanel() {
        ...
        ageModel.addElement("19 to 60");
        ageModel.addElement("61 or over");
    ...
    private void promptName() {
        String answer = JOptionPane.showInputDialog(FormPanel.this, "Name can't be empty. Enter a name",
                "Input dialog", JOptionPane.OK_OPTION | JOptionPane.QUESTION_MESSAGE);
        if (answer == null || answer.isEmpty()) {
            return;
        }
        nameField.setText(answer);
    }
