...
public class FormPanel extends JPanel {
    ...
    public FormPanel() {
        ...
        isUsCitizen = new JCheckBox();
        isUsCitizen.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                taxIdLabel.setEnabled(isUsCitizen.isSelected());
                taxIdField.setEnabled(isUsCitizen.isSelected());
            }
        });
        ...
        okBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                FormEvent event = new FormEvent(this, nameField.getText(), occupationField.getText(),
                        ...
                        isUsCitizen.isSelected(), taxIdField.getText());
